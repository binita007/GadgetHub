			...
			if($row['numrows'] > 0){
				...
				try{
				    ...
				    try {
				        ...
				        $mail->SMTPAuth = true;                               
				        $mail->Username = 'samiksha.ghimire2003@gmail.com';     
				        $mail->Password = 'mgzd caaq bmza zonf';                    
				        ...
				        $mail->setFrom('samiksha.ghimire2003@gmail.com');
				        
				        //Recipients
				        $mail->addAddress($email);              
				        $mail->addReplyTo('samiksha.ghimire2003@gmail.com');
